...
class Nginx:
    ...
    @staticmethod
    def parse_log_line(line: str, config_columns: dict[str, int]) -> LogLine.LogLine|None:
        try:
        ...
        req_ts = columns[config_columns['time_local']] + ' ' + columns[config_columns['time_local'] + 1]
