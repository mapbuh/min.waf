...
def test_parse_log_line(monkeypatch: pytest.MonkeyPatch):
    log_format = '"$remote_addr" $host [$time_local] "$request" $status $body_bytes_sent $request_length $bytes_sent "$http_referer" "$http_user_agent" $request_time "$gzip_ratio" "$geoip2_data_country_iso_code" "$upstream_response_time"';
    columns = Nginx.parse_log_format(log_format)
    # Compose a log line with all required fields
    line = '"1.2.3.4" www.example.com [01/Dec/2025:00:05:25 +0200] "GET /media/products/images/4311/upr6NnW1Z1kx72U8AxuHaRAkeaTEREAdSmv5Yary_thumb.png/polet-s-balon-nad-belogradchishkite-skali-snimka_16696_thumb.png HTTP/2.0" 200 6550 124 6821 "https://www.example.com/vaucheri-za-prezhivyavane/adrenalin/vav-vazduha?utm_source=googleads&utm_medium=cpc&utm_campaign=GE+-+Performance+Search+for+Bestseller+&utm_term=Vuzduh&utm_source=google&utm_medium=cpc&utm_campaign=20801060342&utm_content=&utm_term=&tw_source=google&tw_adid=&tw_campaign=20801060342&tw_kwdid=&gad_source=1&gad_campaignid=20804954761&gbraid=0AAAAADFa9oZZT8kxpKoGlAzg_c7xJvWbR&gclid=CjwKCAiA86_JBhAIEiwA4i9Ju3LVr9LtLpJblVYHhU6kUT1JD2zUO5YMtR4VUe8sQOKlBlmKhei-XxoCUwQQAvD_BwE" "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Mobile Safari/537.36" 0.468 "-" "BG" "0.047"'
    ...
    assert log_line.path == "/media/products/images/4311/upr6NnW1Z1kx72U8AxuHaRAkeaTEREAdSmv5Yary_thumb.png/polet-s-balon-nad-belogradchishkite-skali-snimka_16696_thumb.png"
    assert log_line.http_status == 200
    assert log_line.req == "www.example.com/media/products/images/4311/upr6NnW1Z1kx72U8AxuHaRAkeaTEREAdSmv5Yary_thumb.png/polet-s-balon-nad-belogradchishkite-skali-snimka_16696_thumb.png"
    assert log_line.ua == "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Mobile Safari/537.36"
